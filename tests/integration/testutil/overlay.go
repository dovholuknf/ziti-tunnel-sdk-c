...
func (o *Overlay) CreateDialServicePolicy(name, identityName, serviceName string, postureCheckNames ...string) error {
	args := []string{
		"edge", "create", "service-policy", name, "Dial",
		"--identity-roles", "@" + identityName,
		"--service-roles", "@" + serviceName,
		"--semantic", "AnyOf",
	}
	if len(postureCheckNames) > 0 {
		...
		args = append(args, "--posture-check-roles", strings.Join(roles, ","))
	}
	if _, err := o.execZiti(args...); err != nil {
...
func (o *Overlay) CreateProcessMultiPostureCheck(t *testing.T, name, osType, path string) {
	_, err := o.execZiti("edge", "create", "posture-check", "process-multi", name, "AllOf", osType, path)
...
func (o *Overlay) CreateOSPostureCheck(t *testing.T, name, osSpec string) {
	_, err := o.execZiti("edge", "create", "posture-check", "os", name, "-o", osSpec)
